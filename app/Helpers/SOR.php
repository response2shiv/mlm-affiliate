...
class SOR
{
    ...
    public function __construct($product)
    {
        ...
        } else if (in_array($product, [4, 13, 16])) {
        ...
        } else if ($product == 'boomerang') {
            // customer
            $this->user_name = \Config::get('api_endpoints.iGo4LessBoomUsername');
            $this->secret =  \Config::get('api_endpoints.iGo4LessBoomPassword');
            $this->clubId = \Config::get('api_endpoints.iGo4LessBoomClubId');
        }
    }
