    ...
    <!-- EMAIL or SMS -->
    <div class="modal fade" tabindex="-1" role="dialog" id="modalSendTypePDF">
                ...
                <div class="modal-body">
                    <div id="test">
                        ...
                        <div class="col-md-6 offset-md-3 mt-3">
                            <input type="text" class="form-control" id="txtSendPDFSMS" placeholder="" value="{{\Auth::user()->phonenumber}}">
                        </div>
                        <div class="col-md-6 offset-md-3 mt-3 form-group">
                            <input type="text" class="form-control" id="txtSendEmailPDF" placeholder="name@email.com" value="{{\Auth::user()->email}}">
                        </div>
                        <div class="col-md-12 mt-4">
                            <button type="button" id="pdfButton" class="btn btn-primary rounded-pill">Submit</button>
                        </div>
                    </div>
