...
@component('layouts.components.modal', ['id' => 'modalCheckout'])
    ...
    <div class="row text-center">
        ...
        <div class="col-12">
            <h3>ncrease your impact!</h3>
            <h3>Choose your upgrade level</h3>

            <h1 style="color: #6894c7">
            <div class="countdown-text" id="countdown-modal"></div>
            </h1>
            <span>time reamining to upgrade</span>
            <br />
            <br />
            ...
            <div class="col-md-4">
                 @if($package->value == 10)
                            <img src="{{ asset('images/fx_icon.png') }}" width="50px" />
                @elseif($package->value == 2)
                    <img src="{{ asset('images/basic_icon.png') }}" width="50px" />
                @elseif($package->value == 3)
                    <img src="{{ asset('images/visionary_icon.png') }}" width="50px" />
                @else
                @endif
                <h3>{{$package->name}}</h3>
                <h4 style="color: #6894c7">${{$package->price}}</h3>
    ...
    @slot('actions')
        ...
        <button class="btn btn-add-cart btnAddToCart" data-product="" data-modal="REDIRECT">ADD TO CART <i class="fa fa-shopping-cart"></i></button>
    @endslot
@endcomponent
...
@prepend('scripts')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('input[name="my_package"]').on('click', function (event) {
                console.log('clicou')
                console.log(this.id)
                $('.btnAddToCart').attr('data-product', this.id)
            })
